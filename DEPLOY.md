...
docker compose -p gear-drop --env-file .env.production logs -f backend worker-critical worker-notifications worker-generation worker-imports worker-reports worker-maintenance beat
